...
% This revision keeps the same geometry-generation algorithm and only
% streamlines the default output settings for publication-style plotting.
...
% The material patch follows the detected crest ridge.
...
% Publication-oriented output defaults.
